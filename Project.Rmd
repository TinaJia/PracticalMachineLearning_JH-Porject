...
```{r}
# out of sample error
table(Pre_Bo, testing$classe)
confusionMatrix(Pre_Bo, testing$classe)
```

# Predicion 
Based on the model training, random forest model outperforms the other two models. The accuracy is Therefore, it is chosen to predict the "classe" type for the 20 observations in the original testing data. 
